...
-- Make azure_ad_object_id nullable (was NOT NULL in V1).
-- Legacy users migrated via V3/V4 and dev users with username/password have no Azure AD object ID.
ALTER TABLE app_user MODIFY COLUMN azure_ad_object_id VARCHAR(255) NULL;
