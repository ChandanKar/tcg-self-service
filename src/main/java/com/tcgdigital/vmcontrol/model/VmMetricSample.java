...
@Entity
@Table(name = "vm_metric_sample")
public class VmMetricSample {

    @Id
    @Column(name = "metric_sample_id", length = 36)
    private String metricSampleId;
    ...
    protected void onCreate() {
        if (metricSampleId == null) {
            metricSampleId = UUID.randomUUID().toString();
        }
    }

    public String getMetricSampleId() { return metricSampleId; }
    public void setMetricSampleId(String metricSampleId) { this.metricSampleId = metricSampleId; }
